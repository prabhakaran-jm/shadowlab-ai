...
4. **Start scan** – click “Start Scan”; the live console shows attack progress. With Gradient configured, attacks are **generated by DigitalOcean Gradient™ AI**.
...
# Optional: set GRADIENT_API_KEY (and GRADIENT_API_URL) for Gradient AI
